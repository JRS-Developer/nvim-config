...
_G.packer_plugins = {
  ...
  ["cmp-npm"] = {
    loaded = true,
    path = "/home/jose/.local/share/nvim/site/pack/packer/start/cmp-npm",
  ...
  ["copilot.vim"] = {
    loaded = true,
    path = "/home/jose/.local/share/nvim/site/pack/packer/start/copilot.vim",
  ...
  ["nvim-cursorword"] = {
    loaded = true,
    path = "/home/jose/.local/share/nvim/site/pack/packer/start/nvim-cursorword",
